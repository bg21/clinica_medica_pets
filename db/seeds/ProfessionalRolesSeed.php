...
class ProfessionalRolesSeed extends AbstractSeed
{
    public function run(): void
    {
        ...
        $defaultRoles = [
            [
                'name' => 'Veterinário',
                'description' => 'Veterinário responsável por consultas e procedimentos médicos',
                'sort_order' => 1,
                'is_active' => true
            ],
            [
                'name' => 'Administrador',
                'description' => 'Administrador da empresa com acesso total ao sistema',
                'sort_order' => 2,
                'is_active' => true
            ],
            [
                'name' => 'Gerente',
                'description' => 'Gerente da empresa com permissões de gestão',
                'sort_order' => 3,
                'is_active' => true
            ],
            [
                'name' => 'Profissional',
                'description' => 'Profissional responsável por atendimentos e serviços',
                'sort_order' => 4,
                'is_active' => true
            ],
            [
            ...
            [
                'name' => 'Banho e Tosa',
                'description' => 'Profissional responsável por banho e tosa de animais',
                'sort_order' => 6,
                'is_active' => true
            ],
            [
                'name' => 'Auxiliar',
                'description' => 'Auxiliar ou atendente',
                'sort_order' => 7,
                'is_active' => true
            ]
        ];
