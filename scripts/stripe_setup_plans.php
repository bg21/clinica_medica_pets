...
try {
    ...
    $plans = [
        'basic' => [
            'name' => 'Plano Básico',
            'description' => 'Ideal para empresas pequenas. Até 1 usuário.',
            'metadata' => [
                'plan_type' => 'basic',
                'max_users' => '1',
                'features' => 'basic'
        ...
        'professional' => [
            ...
            'description' => 'Para empresas de médio porte. Até 5 usuários. Inclui relatórios avançados e histórico completo.',
            'metadata' => [
        ...
        'premium' => [
            'name' => 'Plano Premium',
            'description' => 'Para empresas grandes e redes. Recursos ilimitados, todos os recursos do sistema e suporte prioritário.',
            'metadata' => [
                'plan_type' => 'premium',
                'max_users' => 'unlimited',
                'features' => 'all'
