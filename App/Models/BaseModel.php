...
abstract class BaseModel
{
    ...
    /**
     * ✅ NOVO: Busca registros paginados com formato padronizado
     * 
     * Usa PaginationHelper para obter parâmetros do request e formatar resposta.
     * Retorna dados no formato padronizado com metadados de paginação.
     * 
     * @param array $conditions Condições WHERE
     * @param array $orderBy Ordenação ['campo' => 'ASC|DESC']
     ...
     * @return array Formato: ['data' => array, 'pagination' => array]
     */
    public function findPaginated(
        ...
        if ($paginationParams === null) {
            $paginationParams = \App\Utils\PaginationHelper::getPaginationParams(null, $maxPerPage);
        }
        ...
        // Obtém total de registros (sem paginação)
        $total = $this->count($conditions);
        
        // Formata resposta usando PaginationHelper
        return \App\Utils\PaginationHelper::formatResponse($data, $total, $page, $limit);
    }
    
    /**
     * ✅ NOVO: Retorna instância do QueryBuilder para construir queries fluentes
     * 
