...
<head>
    ...
    <style>
        /* ✅ CORREÇÃO: Resetar qualquer interferência de CSS global */
        * {
        ...
        /* ✅ CORREÇÃO: Garantir que elementos do dashboard não interfiram */
        .sidebar-overlay,
        .mobile-header-bar,
        .sidebar {
        ...
        /* ✅ CORREÇÃO: Garantir que inputs sejam clicáveis */
...
<body>
    <div class="container">
                ...
                <div class="card register-card">
                    <div class="card-body p-5">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="btn-group w-100" role="group">
                                ...
                                <label class="btn btn-outline-primary" for="owner">
                                    <i class="bi bi-building"></i> Sou Dono da Empresa
                                </label>
                        ...
                        <form id="registerForm">
                            ...
                            <!-- Campos para DONO DA EMPRESA -->
                            <div id="ownerFields">
                                <div class="mb-3">
                                    <label class="form-label">Nome da Empresa *</label>
                                    <input type="text" class="form-control" name="company_name" id="company_name" placeholder="ex: Minha Empresa">
                                    <small class="text-muted">Nome da sua empresa</small>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Slug da Empresa</label>
                                    <input type="text" class="form-control" name="company_slug" id="company_slug" pattern="[a-z0-9-]+" placeholder="ex: minha-empresa">
                            ...
                            <div id="employeeFields" style="display: none;">
                                <div class="mb-3">
                                    <label class="form-label">Slug da Empresa *</label>
                                    <input type="text" class="form-control" name="tenant_slug" id="tenant_slug" pattern="[a-z0-9-]+" placeholder="ex: minha-empresa">
                                    <small class="text-muted">Informe o slug da empresa onde você trabalha (ex: minha-empresa)</small>
                                </div>
                            </div>
        ...
        <script>
            // ✅ CORREÇÃO: Garantir que não há elementos bloqueando na página de registro
            document.addEventListener('DOMContentLoaded', function() {
                // Remove qualquer overlay que possa estar presente
                ...
                // Garante que inputs sejam clicáveis
                ...
                allElements.forEach(el => {
                    ...
                    if (zIndex && parseInt(zIndex) > 10000 && !el.closest('.register-card')) {
        ...
        document.querySelectorAll('input[name="user_type"]').forEach(radio => {
            radio.addEventListener('change', function() {
                ...
                document.getElementById('company_name').required = isOwner;
                document.getElementById('company_slug').required = false; // Sempre opcional para dono
        ...
        setupSlugValidation('company_slug');
        setupSlugValidation('tenant_slug');

        // Geração automática de slug a partir do nome da empresa
        ...
        document.getElementById('registerForm').addEventListener('submit', async (e) => {
            ...
            if (userType === 'owner') {
                // Registro de DONO DA EMPRESA
                const companyName = formData.get('company_name')?.trim();
                const companySlug = formData.get('company_slug')?.trim().toLowerCase();
                
                if (!companyName || companyName.length < 3) {
                    validationErrors.push('Nome da empresa deve ter pelo menos 3 caracteres');
                }
                
                if (companySlug && !/^[a-z0-9-]+$/.test(companySlug)) {
                    validationErrors.push('Slug da empresa deve conter apenas letras minúsculas, números e hífens');
                }
                
                if (companySlug && companySlug.length < 3) {
                    validationErrors.push('Slug da empresa deve ter pelo menos 3 caracteres');
                }
                ...
                if (!tenantSlug) {
                    validationErrors.push('Slug da empresa é obrigatório');
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    if (response.status === 404) {
                        errorMessage = 'Empresa não encontrada. Verifique se o slug está correto.';
