...
O sistema SaaS oferece **3 planos** para empresas:

| Plano | Usuários | Recursos |
|-------|----------|----------|
| **Básico** | 1 | Básicos |
| **Profissional** | Até 5 | Relatórios Avançados |
...
Baseado em sistemas SaaS similares, seguem sugestões de preços:
...
**Justificativa:**
- Preços acessíveis para atrair empresas pequenas
...
- Ainda acessível para empresas estabelecidas
...
- Maior margem de lucro
- Foco em empresas grandes e redes
...
2. Preencha:
   - **Nome:** `Plano Básico`
   - **Descrição:** `Ideal para empresas pequenas. 1 usuário e recursos básicos.`
...
2. Preencha:
   ...
   - **Descrição:** `Para empresas de médio porte. Até 5 usuários. Inclui relatórios avançados e histórico completo.`
   - **Imagem:** (opcional) Logo do seu SaaS
   - **Metadata:**
     ```json
     {
...
2. Preencha:
   - **Nome:** `Plano Premium`
   - **Descrição:** `Para empresas grandes e redes. Recursos ilimitados, todos os recursos do sistema e suporte prioritário.`
   - **Imagem:** (opcional) Logo do seu SaaS
   - **Metadata:**
     ```json
     {
